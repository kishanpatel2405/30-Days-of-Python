...
# 11	Declaring and Calling a Function
...
# 11	Function Returning a Value - Part 1
...
def greetings(name):
    message = name + ', welcome to the site!'
    return message


print(greetings('kishan'))
...
# 11	Passing Arguments with Key and Value
...
# 11	Function Returning a Value - Part 2
...
print(ab('kishan', 'bhai'))


# 11	Function with Default Parameters

def function(name='kishan'):
    print(name)
...
# 11	Default and Arbitrary Number of Parameters in Function
...
# Write a function called add_all_nums which takes arbitrary number of arguments and sums all the arguments. Check if
...
print(add_two_numbers(2, 3, 3, 1, 23, 14))
print(add_two_numbers(2, 'two'))


# Temperature in °C can be converted to °F using this formula: °F = (°C x 9/5) + 32. Write a function which converts
# °C to °F, convert_celsius_to-fahrenheit.
...
def calculate_slope(x1, y1, x2, y2):
    if x1 == x2:
        raise ValueError("The x-coordinates cannot be the same; the line is vertical and the slope is undefined.")
    slope = (y2 - y1) / (x2 - x1)
    return slope
...
print("The slope of the line through points ({}, {}) and ({}, {}) is: {}".format(x1, y1, x2, y2, slope))
...
print(capitalize_list_items(['vinesh', 'binod', 'kishan']))
...
def sum_of_numbers(n):
    ...
    for i in range(1, n + 1):
        total += i
    return total, 'is the total number'
...
result = sum_of_evens(50)
print(result)


# 11	Exercises: Level 2
...
lst = ['nowplaying', 'PBS',  'job', 'debate', 'thenandnow']
print("All items unique:", are_items_unique(lst))
...
print(same_type(lst1))
print(same_type(lst2))
print(same_type(lst3))
...
print(is_valid('variable_name'))
print(is_valid('_variable'))
print(is_valid('2variable'))
print(is_valid('class'))
...
def most_spoken_languages(data, top_n=10):
    ...
    for country in data:
        ...
        for language in languages:
            if language in language_speakers:
                language_speakers[language] += population
            else:
                language_speakers[language] = population
    language_list = [(language, speakers) for language, speakers in language_speakers.items()]

    for i in range(len(language_list)):
        for j in range(i + 1, len(language_list)):
            if language_list[i][1] < language_list[j][1]:
                language_list[i], language_list[j] = language_list[j], language_list[i]
    return language_list[:top_n]
top_languages = most_spoken_languages(data, top_n=10)
